(function () {
  ...
  function applyStatusBarLock() {
    ...
    if (isIOSDevice()) {
      ...
      root.classList.remove("routee-android", "routee-android-standalone");
    } else if (isAndroidDevice()) {
      root.classList.add("routee-android");
      root.classList.toggle("routee-android-standalone", isStandaloneMode());
      root.classList.toggle("routee-android-native-surface", isStandaloneMode());
    }
    ...
    if (document.body) {
      ...
      if (isIOSDevice()) {
        ...
        document.body.classList.remove("routee-android", "routee-android-standalone");
      } else if (isAndroidDevice()) {
        document.body.classList.add("routee-android");
        document.body.classList.toggle("routee-android-standalone", isStandaloneMode());
        document.body.classList.toggle("routee-android-native-surface", isStandaloneMode());
      }
