const SW_VERSION = new URL(self.location.href).searchParams.get("v") || "2026.06.23.3-saved-maps-force-reload-fix";
const CACHE_NAME = `routee-shell-${SW_VERSION}`;
const NETWORK_TIMEOUT_MS = 1200;
const ROUTEE_ASSET_REVISION = "2026.06.23.3-saved-maps-force-reload-fix";
